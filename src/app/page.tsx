...
import Landing from "./../../public/copimoBanner.png";
import {
  LoginLink,
  RegisterLink,
...
export default function Home() {
  return (
    <>
      ...
      <MaxWidthWrapper className="mb-12 mt-12 sm:mt-24 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="max-w-4xl mb-6 text-5xl font-bold md:text-6xl lg:text-7xl">
          Scopri il potere dello studio intelligente con
          <span className="text-blue-600"> Kopimo </span>
        </h1>
        <div className="display: flex">
          ...
          <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
            Ora puoi esplorare i PDF in modo più facile. L&apos;IA qui può
            tirare fuori il succo da documenti lunghi, spiegarti cose complesse,
            trovare info importanti in un attimo e addirittura darti
            suggerimenti su domande da fare. Cool, eh?
          </p>
          <span>
            <Image
              src="/coolemo.png"
 ...
 */}
      ...
      {/* Feature section */}
      <div className="mx-auto max-w-6xl mb-32 mt-12 sm:mt-32">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="mt-2 mb-9 font-bold text-4xl text-gray-900 sm:text-5xl">
              Ecco come funziona
            </h2>
